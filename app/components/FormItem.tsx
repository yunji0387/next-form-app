...
export default function FormItem({ formData }: FormItemProps) {
  ...
  return (
    ...
    >
      ...
      <div className="hidden group-hover:flex w-1/4 justify-around">
        <button
          className="bg-gray-200 hover:bg-gray-100 w-[30%] h-6 text-xs text-gray-800 border border-gray-700 rounded"
          onClick={(e) => {
            e.stopPropagation();
